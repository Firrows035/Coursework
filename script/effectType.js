...
var revivalF=new function(){
    effectType.set("revival",{
        ...
        expire(target,self){
            character.get("Tairitsu-Tempest").onClick();
            return 0;
        },
        maxDuration:99,
        isSelectable:true,
